...
public class Service_ThuocTinhSanPham {
    ...
    public ArrayList<Model_ThuocTinhSanPham> getAllDanhMuc() {
    ...
    public int themDanhMuc(Model_ThuocTinhSanPham ttsp) {
    ...
    public Model_ThuocTinhSanPham ckeckMaDanhMuc(String matr) {
        sql = "select MaDanhMuc,TenDanhMuc from DanhMucSanPham where MaDanhMuc = ?";
        Model_ThuocTinhSanPham ttsp = null;
        try {
            ps = con.prepareStatement(sql);
            ps.setObject(1, matr);
    ...
    public int SuaDM(String madm, Model_ThuocTinhSanPham ttspnew){
        sql = "update DanhMucSanPham set TenDanhMuc = ? where MaDanhMuc = ?";
        try {
            ps = con.prepareStatement(sql);
            ps.setObject(1, ttspnew.getTenThuocTinh());
            ps.setObject(2, madm);
